...
def hitung():
    ...
    if operator == "+":
        ...
        hasil = angka1 - angka2  # Koreksi di sini
    elif operator == "*":
        hasil = angka1 * angka2
    elif operator == "/":
        hasil = angka1 / angka2
...
operator_label.grid(row=2, column=0, sticky="w")  # Koreksi pada label
operator_combobox = ttk.Combobox(input_frame, values=["+", "-", "*", "/"])
operator_combobox.grid(row=2, column=1)  # Koreksi pada combobox
